...
cms_newgrid.SPM.encoding.pop('coordinates')
cms_newgrid.to_netcdf(opath, encoding={'lat': cms_newgrid.lat.encoding, 'lon': cms_newgrid.lon.encoding, 'time': cms_newgrid.time.encoding, 'SPM': cms_newgrid.SPM.encoding})
